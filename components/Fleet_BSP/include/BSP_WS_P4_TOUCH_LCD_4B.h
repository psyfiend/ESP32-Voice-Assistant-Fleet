#pragma once
#ifndef BSP_WS_P4_TOUCH_LCD_4B_H
#define BSP_WS_P4_TOUCH_LCD_4B_H
...
const BoardHardware WS_P4_TOUCH_LCD_4B_HARDWARE = {
    .device_name  = "Waveshare P4-Touch-LCD-4B",
    .MANUFACTURER = "Waveshare",
    .MODEL        = "ESP32-P4-WIFI6-Touch-LCD-4B",
    .SI_REV       = "unconfirmed",

    .SDA_PIN = 7,
    .SCL_PIN = 8,
    .I2C_CLOCK_SPEED = 100000, // The one board where the old general-bus and touch-controller values actually agreed

    .BOOT_BUTTON_PIN = 35,
    .I2S_AMP_EN      = 53,   // NS4150B on WS Smart86 boxes
};
...
const DisplayConfig WS_P4_TOUCH_LCD_4B_DISPLAY = {
    ...
    // ---= Init Commands =---
    .INIT_CMDS_DSI  = ws_p4_touch_lcd_4b_init,
    .INIT_CMDS_SIZE = sizeof(ws_p4_touch_lcd_4b_init) / sizeof(lcd_init_cmd_t),

    // Panel diagonal in tenths of an inch (4.0" Waveshare P4-Touch-LCD-4B).
    // 720x720 over 4.0" = ~255 PPI, so bspUiScale() = 1.50.
    .DIAGONAL_IN = 40,
};
inline const DisplayConfig& bsp_display = WS_P4_TOUCH_LCD_4B_DISPLAY;

const TouchConfig WS_P4_TOUCH_LCD_4B_TOUCH = {
    .NAME            = "GT911",
    .I2C_ADDR        = 0x5D,
    .SDA             = 7,
    .SCL             = 8,
...
inline const TouchConfig& bsp_touch = WS_P4_TOUCH_LCD_4B_TOUCH;

const AudioConfig WS_P4_TOUCH_LCD_4B_AUDIO = {
...
inline const AudioConfig& bsp_audio = WS_P4_TOUCH_LCD_4B_AUDIO;

const StorageConfig WS_P4_TOUCH_LCD_4B_STORAGE = {
    .TF_CMD = 44,
    .TF_CLK = 43,
    .TF_D0  = 39,
    .TF_D1  = 40,
...
inline const StorageConfig& bsp_storage = WS_P4_TOUCH_LCD_4B_STORAGE;
...
#endif // BSP_WS_P4_TOUCH_LCD_4B_H
