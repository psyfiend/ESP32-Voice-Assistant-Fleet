 ...
 * Size: 32 px
 * Bpp: 4
 * Opts: --font C:\Users\Marge\Documents\PlatformIO\Projects\ESP32 Voice Assistant Fleet\components\lvgl\scripts\built_in_font\Montserrat-Medium.ttf -r 0x20,0x2B,0x2D,0x2E,0x30-0x39,0x3A,0x64,0xB0 --size 32 --bpp 4 --format lvgl --no-compress --lv-include lvgl.h -o C:\Users\Marge\Documents\PlatformIO\Projects\ESP32 Voice Assistant Fleet\src\UI\fonts\fleet_font_num_32.c
 ******************************************************************************/
...
#ifndef FLEET_FONT_NUM_32
#define FLEET_FONT_NUM_32 1
#endif

#if FLEET_FONT_NUM_32
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 105, .adv_w = 196, .box_w = 10, .box_h = 3, .ofs_x = 1, .ofs_y = 7},
    {.bitmap_index = 120, .adv_w = 116, .box_w = 5, .box_h = 5, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 133, .adv_w = 342, .box_w = 19, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 342, .adv_w = 189, .box_w = 9, .box_h = 22, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 441, .adv_w = 294, .box_w = 18, .box_h = 22, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 639, .adv_w = 293, .box_w = 17, .box_h = 22, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 826, .adv_w = 343, .box_w = 21, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1057, .adv_w = 294, .box_w = 18, .box_h = 22, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1255, .adv_w = 316, .box_w = 18, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1453, .adv_w = 306, .box_w = 18, .box_h = 22, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1651, .adv_w = 330, .box_w = 19, .box_h = 22, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1860, .adv_w = 316, .box_w = 19, .box_h = 22, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2069, .adv_w = 116, .box_w = 5, .box_h = 17, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2112, .adv_w = 349, .box_w = 18, .box_h = 24, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2328, .adv_w = 215, .box_w = 11, .box_h = 10, .ofs_x = 1, .ofs_y = 12}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t fleet_font_num_32 = {
#else
lv_font_t fleet_font_num_32 = {
#endif
