 ...
 * Size: 42 px
 * Bpp: 4
 * Opts: --font C:\Users\Marge\Documents\PlatformIO\Projects\ESP32 Voice Assistant Fleet\components\lvgl\scripts\built_in_font\Montserrat-Medium.ttf -r 0x20,0x2B,0x2D,0x2E,0x30-0x39,0x3A,0x64,0xB0 --size 42 --bpp 4 --format lvgl --no-compress --lv-include lvgl.h -o C:\Users\Marge\Documents\PlatformIO\Projects\ESP32 Voice Assistant Fleet\src\UI\fonts\fleet_font_num_42.c
 ******************************************************************************/
...
#ifndef FLEET_FONT_NUM_42
#define FLEET_FONT_NUM_42 1
#endif

#if FLEET_FONT_NUM_42
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 391, .box_w = 20, .box_h = 19, .ofs_x = 2, .ofs_y = 6},
    {.bitmap_index = 190, .adv_w = 257, .box_w = 12, .box_h = 4, .ofs_x = 2, .ofs_y = 10},
    {.bitmap_index = 214, .adv_w = 153, .box_w = 7, .box_h = 6, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 235, .adv_w = 448, .box_w = 24, .box_h = 30, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 595, .adv_w = 249, .box_w = 12, .box_h = 30, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 775, .adv_w = 386, .box_w = 23, .box_h = 30, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1120, .adv_w = 384, .box_w = 23, .box_h = 30, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 1465, .adv_w = 450, .box_w = 27, .box_h = 30, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 1870, .adv_w = 386, .box_w = 23, .box_h = 30, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 2215, .adv_w = 415, .box_w = 23, .box_h = 30, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2560, .adv_w = 402, .box_w = 23, .box_h = 30, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 2905, .adv_w = 433, .box_w = 25, .box_h = 30, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3280, .adv_w = 415, .box_w = 23, .box_h = 30, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3625, .adv_w = 153, .box_w = 7, .box_h = 23, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 3706, .adv_w = 458, .box_w = 24, .box_h = 32, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4090, .adv_w = 282, .box_w = 15, .box_h = 14, .ofs_x = 1, .ofs_y = 16}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t fleet_font_num_42 = {
#else
lv_font_t fleet_font_num_42 = {
#endif
